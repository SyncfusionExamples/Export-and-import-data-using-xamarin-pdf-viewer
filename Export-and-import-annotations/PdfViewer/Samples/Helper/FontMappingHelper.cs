...
namespace SampleBrowser.SfPdfViewer
{
    public class FontMappingHelper
    {
        ...
        public static string ImportExportFont = Device.RuntimePlatform == Device.Android ? "ImportsExport.ttf" :
             Device.RuntimePlatform == Device.iOS ? "ImportsExport" : "/Assets/Fonts/ImportsExport.ttf#ImportsExport";
    }
}
