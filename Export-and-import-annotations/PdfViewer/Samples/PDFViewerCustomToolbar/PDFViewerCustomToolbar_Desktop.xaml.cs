...
namespace SampleBrowser.SfPdfViewer
{
    ...
    public partial class PDFViewerCustomToolbar_Desktop : SampleView
    {
        ...
        private Stream fdfStreamFormData;
        ...
        private void Export_Clicked(object sender, EventArgs e)
        {
            ...
            DependencyService.Get<IAlertView>().Show("Exported the existing form data. Now, please import the details in the new/updated document by clicking the 'Import' icon.");
            ...
            //Stream stream = typeof(App).GetTypeInfo().Assembly.GetManifestResourceStream("SampleBrowser.SfPdfViewer.Assets.FormFillingDocument2.pdf");
            //pdfViewer.LoadDocument(stream);
            //DependencyService.Get<IAlertView>().Show("Exported the existing form data. Now, please import the details in the new/updated document by clicking the 'Import' icon.");
        ...
        private void Import_Clicked(object sender, EventArgs e)
        {
            ...
            DependencyService.Get<IAlertView>().Show("Imported the form data successfully in the new/updated document.");
