...
namespace SampleBrowser.SfPdfViewer.iOS
{
	public class SfFontButtonRenderer : ButtonRenderer
	{
		...
		protected override void OnElementChanged(ElementChangedEventArgs<Button> e)
		{
			...
			Control.Font = font;
            //if ((Element as SfFontButton).ButtonName == "Import" || (Element as SfFontButton).ButtonName == "Export")
            //{
            //    Control.TitleLabel.AdjustsFontSizeToFitWidth = true;
            //    Control.TitleLabel.AutoresizingMask = UIViewAutoresizing.All;
            //    Control.TitleLabel.BackgroundColor = UIColor.Black;
            //    Control.TitleEdgeInsets = UIEdgeInsets.Zero;
